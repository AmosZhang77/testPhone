<template>
  <div class="learner">
    <div class="pdfBox" style="width: 100%;">
      ...
      <!--<div >
        ...
        &lt;!&ndash;  <select v-model="src" style="width: 30em">
        ...
        &lt;!&ndash;<button @click="rotate += 90">&#x27F3;</button>
        <button @click="rotate -= 90">&#x27F2;</button>&ndash;&gt;
    ...
    <div class="questionBox">
      ...
      <div>
        ...
        <el-button class="submitBtn" type="primary" @click="submitQuestion" v-show="page == pages.length">提交答案</el-button>
       ...
       this.pages[i].pageNum = i+1;
        ...
        for (let i = 0; i < this.pages.length; i++) {
          for (let j = 0; j < this.pages[i].questions.length; j++) {
            ...
            this.pages[i].questions[j].questionCode = count
            count=count+1
          }
        }
      },
